  ...
  const handleRegistrationSubmit = async () => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        // Optionally refresh the events list to show updated registration status
        fetchEvents();
      }
    } catch (error) {
    ...
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50">
      <div className="bg-gray-800 p-8 rounded-xl max-w-md w-full mx-4">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-300">Venue: {selectedEvent?.venue}</p>
          <p className="text-gray-300">Date: {selectedEvent?.date}</p>
          <p className="text-gray-300">Time: {selectedEvent?.time}</p>
        </div>
                        ...
                        >
                          <div className="flex flex-col md:flex-row gap-6 items-start">
                            ...
                            <div className="flex-1 space-y-4">
                              ...
                              <button
                                onClick={() =>
                                  handleRegisterClick(event.details)
                                }
